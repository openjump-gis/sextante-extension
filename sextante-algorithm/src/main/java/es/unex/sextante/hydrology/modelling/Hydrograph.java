...
public class Hydrograph {
   ...
   public String toString() {
      ...
      sb.append("Flow rate : " + getPeak() + " m3/s\n");
      sb.append("Peak Time : " + transformSecToHourMin(getPeakTime()) + " \n");
      sb.append("Total volume of runoff : " + getTotalRunoff() + " m3\n");
      sb.append("Total duration of the hydrograph : " + transformSecToHourMin(getLengthInIntervals() * m_iTimeInterval) + "\n");
