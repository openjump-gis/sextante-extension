...
public class RasterizeVectorLayer2Algorithm extends GeoAlgorithm
{
	...
	public void defineCharacteristics() {
		this.setName(Sextante.getText("Rasterize_vector_layer")+ " (2)");
	...
	private void doPolygonPart(final Polygon geom, final double dValue, final boolean bIsHole) {
	...
	private void doLineString(final Geometry geom, final double dValue) {
